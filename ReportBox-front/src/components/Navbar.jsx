            ...
            {userInfo ? (
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown size={16} className={`transition-all duration-300 group-hover:scale-110 ${isProfileOpen ? 'rotate-180 text-blue-400' : ''}`} />
                </button>
                
                <div className={`absolute top-full right-0 mt-2 w-48 bg-slate-800/95 backdrop-blur-md rounded-xl shadow-2xl border border-slate-700/50 z-50 transition-all duration-300 origin-top ${
                  isProfileOpen 
                    ? 'opacity-100 scale-100 translate-y-0' 
                    : 'opacity-0 scale-95 -translate-y-2 pointer-events-none'
                }`}>
                  <div className="py-2">
                    ...
                    <button
                      ...
                      className="flex items-center space-x-2 w-full text-left px-4 py-3 text-sm text-slate-300 hover:text-red-400 hover:bg-slate-700/50 transition-all duration-200 border-l-2 border-transparent hover:border-red-400"
                    >
                      <LogOut size={16} />
                      <span>Logout</span>
                    </button>
        ...
        <div className="px-4 pt-2 pb-3 space-y-1">
          ...
          {userInfo ? (
            <>
              ...
              >
                <User size={20} />
                <span>{userInfo.username || userInfo.name || 'Profile'}</span>
              </a>
              <button
                onClick={handleLogout}
                className="flex items-center space-x-3 text-slate-300 hover:text-red-400 hover:bg-slate-800/50 w-full px-3 py-3 rounded-lg font-medium transition-all duration-300"
              >
                <LogOut size={20} />
                <span>Logout</span>
              </button>
